...
function update() {
    ...
    world.step(timeStep * 0.5);
        ...
        //console.log("vel: " + wheel.body.angularVelocity);
        //console.log("arrow: " + arrow.hasStopped());
    if (wheelSpinning === true && wheelStopped === false && wheel.body.angularVelocity < 1 && 
        arrow.hasStopped() && wheel.gotLucky()) {
...
Wheel.prototype = {
    ...
    draw:function() {
        ...
        ctx.arc(0, 0, this.pRadius + 12, 0, TWO_PI);
        ctx.fill();
        ...
        for (var i = 0; i < this.segments; i++) {
            ctx.fillStyle = (i % 2 === 0) ? '#DB5EBA' : '#5EA9DB';
            ctx.beginPath();
